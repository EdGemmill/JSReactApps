...
section on handling events in React, such as an `onClick` button. Hard to think of
anything interesting that could happen with a single button that isn't a
